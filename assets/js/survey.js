window.addEventListener("DOMContentLoaded", () => {
    ...
    function askWho() {
        ...
        text.textContent="I'm Nathan, Student Ambassador. I'm here to guide you!";
    ...
    function q1() {
        ...
        showChoices([{ label:"Enter name", action:getName }]);
    }
    ...
    function endSurvey() {
        ...
        showChoices([{ label:"Begin", action:()=>window.location.href="game.html" }]);
    }
